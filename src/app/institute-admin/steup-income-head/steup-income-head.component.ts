...
@Component({
  selector: 'app-steup-income-head',
  templateUrl: './steup-income-head.component.html',
  styleUrl: './steup-income-head.component.css'
})
export class SteupIncomeHeadComponent implements OnInit {
