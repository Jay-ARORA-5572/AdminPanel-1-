...
@Component({
  selector: 'app-addpostalpackages',
  templateUrl: './addpostalpackages.component.html',
  styleUrl: './addpostalpackages.component.css'
})
export class AddpostalpackagesComponent {

  constructor(private messageService: MessageService, public dialogRef: MatDialogRef<AddpostalpackagesComponent>) { }
