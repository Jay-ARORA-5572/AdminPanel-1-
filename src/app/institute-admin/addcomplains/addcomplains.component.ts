...
@Component({
  selector: 'app-addcomplains',
  templateUrl: './addcomplains.component.html',
  styleUrl: './addcomplains.component.css'
})
export class AddcomplainsComponent {

  constructor(private messageService: MessageService, public dialogRef: MatDialogRef<AddcomplainsComponent>) { }
