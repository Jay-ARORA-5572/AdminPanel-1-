...
@Component({
  selector: 'app-addadmissionenquiry',
  templateUrl: './addadmissionenquiry.component.html',
  styleUrl: './addadmissionenquiry.component.css'
})
export class AddadmissionenquiryComponent {

  constructor(private messageService: MessageService, public dialogRef: MatDialogRef<AddadmissionenquiryComponent>) { }
