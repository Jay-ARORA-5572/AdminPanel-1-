...
@Component({
  selector: 'app-upgraded-student',
  templateUrl: './upgraded-student.component.html',
  styleUrl: './upgraded-student.component.css'
})
export class UpgradedStudentComponent implements OnInit {
