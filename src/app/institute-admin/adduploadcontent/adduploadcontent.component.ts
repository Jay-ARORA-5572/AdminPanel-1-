...
@Component({
  selector: 'app-adduploadcontent',
  templateUrl: './adduploadcontent.component.html',
  styleUrl: './adduploadcontent.component.css'
})
export class AdduploadcontentComponent {
  ...
  constructor(private confirmationService: ConfirmationService, private messageService: MessageService, public dialogRef: MatDialogRef<AdduploadcontentComponent>) { }
