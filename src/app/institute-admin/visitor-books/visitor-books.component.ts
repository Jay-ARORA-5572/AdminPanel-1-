...
@Component({
  selector: 'app-visitor-books',
  templateUrl: './visitor-books.component.html',
  styleUrl: './visitor-books.component.css'
})
export class VisitorBooksComponent implements OnInit {
