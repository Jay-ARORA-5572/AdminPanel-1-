...
@Component({
  selector: 'app-steup-expense-head',
  templateUrl: './steup-expense-head.component.html',
  styleUrl: './steup-expense-head.component.css'
})
export class SteupExpenseHeadComponent implements OnInit {
