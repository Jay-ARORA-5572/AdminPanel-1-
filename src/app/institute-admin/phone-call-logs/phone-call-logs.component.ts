...
@Component({
  selector: 'app-phone-call-logs',
  templateUrl: './phone-call-logs.component.html',
  styleUrl: './phone-call-logs.component.css'
})
export class PhoneCallLogsComponent implements OnInit {
...
addnew() {
  const dialogRef = this.dialog.open(AddphonecalllogsComponent, {
    width: "60%",
    // height: "75%",
    height: "auto",
  });
