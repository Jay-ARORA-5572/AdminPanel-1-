...
@Component({
  selector: 'app-visitorbooks',
  templateUrl: './visitorbooks.component.html',
  styleUrl: './visitorbooks.component.css'
})
export class VisitorbooksComponent {

  constructor(private messageService: MessageService, public dialogRef: MatDialogRef<VisitorbooksComponent>) { }
