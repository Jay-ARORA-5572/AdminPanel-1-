...
@Component({
  selector: 'app-addadmissionlist',
  templateUrl: './addadmissionlist.component.html',
  styleUrl: './addadmissionlist.component.css'
})
export class AddadmissionlistComponent {

  constructor(private messageService: MessageService, public dialogRef: MatDialogRef<AddadmissionlistComponent>) { }
