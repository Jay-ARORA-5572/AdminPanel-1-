...
@Component({
  selector: 'app-addmission-enquiry',
  templateUrl: './addmission-enquiry.component.html',
  styleUrl: './addmission-enquiry.component.css'
})
export class AddmissionEnquiryComponent implements OnInit {
  ...
  addnew() {
    const dialogRef = this.dialog.open(AddadmissionenquiryComponent, {
      width: "60%",
      // height: "75%",
      height: "auto",
    });
