...
export class ViewstudentComponent {
  ...
  quizviewDetails(quiz: Quiz) {
    ...
    //   },
    // });
    console.log("QuizresultdetailsDialogComponent shows");
  }
  ...
  examviewDetails(exam: Exam) {
    ...
    //   },
    // });
    console.log("ExamresultdetailsDialogComponent shows");
  }
  ...
  assignmentviewDetails(assignment: Assignment) {
    ...
    //   },
    // });
    console.log("AssignmentresultdetailsDialogComponent shows");
  }
  // -----------------------------------Classes Section----------------------------------
