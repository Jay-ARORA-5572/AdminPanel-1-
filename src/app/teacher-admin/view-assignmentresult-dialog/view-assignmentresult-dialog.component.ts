...
@Component({
  selector: 'app-view-assignmentresult-dialog',
  templateUrl: './view-assignmentresult-dialog.component.html',
  styleUrl: './view-assignmentresult-dialog.component.css'
})
export class ViewAssignmentresultDialogComponent {
  dialogRef: any;
