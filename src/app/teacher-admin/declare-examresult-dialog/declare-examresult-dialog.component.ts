...
@Component({
  selector: 'app-declare-examresult-dialog',
  templateUrl: './declare-examresult-dialog.component.html',
  styleUrl: './declare-examresult-dialog.component.css'
})
export class DeclareExamresultDialogComponent {
  ...
  response() {
   ...
   // ----------------------------------Result button content ts-----------------------------------
    ...
    students = [
      { id: 'TIPSGHM 202', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 206', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 203', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 206', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 202', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 203', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
      { id: 'TIPSGHM 206', name: 'Harsh Kadyan', attachment: 'math_quiz.pdf', attachmentName: 'math_quiz.pdf', marks: '', note: '' },
